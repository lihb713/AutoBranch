...
④ 语义容器嵌套深度由 LOD 控制（见 ``webops.semantic_graph.lod``）；
...
from webops.browser.models import DomSnapshot, ElementNode
from webops.semantic_graph.models import Element, Region, normalize_role
