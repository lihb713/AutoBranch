...
from autobranch.plugins.browser.driver.models import DomSnapshot, LODSpec
from autobranch.plugins.browser.semantic_graph.budget import check_budget
...
from autobranch.plugins.browser.semantic_graph.lod import (
    apply_attributes,
    crop_depth_breadth,
    filter_relations,
)
...
from autobranch.plugins.browser.semantic_graph.programmatic import run_programmatic
from autobranch.plugins.browser.semantic_graph.refs import build_ref_map
