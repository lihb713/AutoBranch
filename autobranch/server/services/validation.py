...
from autobranch.parser.errors import InvalidDocumentError
from autobranch.parser.models import CheckIssue, DocumentSource, ParseResult
...
def validate_document(
    ...
    ``registry``（插件注册表）非空时校验 FunctionCall 函数存在性（按全名）。
    """
    result = _parse(content, doc_id, resolver, registry)
